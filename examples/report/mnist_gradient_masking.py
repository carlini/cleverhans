...
This is a model that intentionally masks the gradient at the logits layer as a test case.
Doesn't quite work as of end of hackathon, the OptionalZeroGradient class has some trouble
with discarding shape information.
"""
...
from cleverhans.picklable_model import Conv2D, ReLU, Flatten, Linear, Softmax, MLP, Layer, OptionalZeroGradient

silence()

      

def make_masked_cnn(nb_filters=64, nb_classes=10,
                             input_shape=(None, 28, 28, 1)):
  """The model for the picklable models tutorial.
  """
  mask = OptionalZeroGradient()
